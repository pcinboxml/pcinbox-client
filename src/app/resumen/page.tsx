...
const Resumen = () => {
  ...
  const { hasToken, setDataModal } = useTheContext();

  const { onRouterLink, formatCurrency, productsToShow } = useService();
              ...
              <div className="flex flex-col justify-end items-center gap-2">
                ...
                <span className="text-[#808080] text-sm">
                  ...
                  {productsToShow
                    ...
                    ? formatCurrency(Number(costoEnvio))
                ...
                <span className="text-[#808080] text-sm">
                  ...
                  {productsToShow
                    ...
                    ? formatCurrency(Number(costoSeguro))
                        ...
                        : summary?.paymentMethod?.name == "tarjeta_al_recoger"
                          ...
                          : summary?.paymentMethod?.name == "efectivo"
                            ...
                            : summary?.paymentMethod?.name == "mercadopago"
                              ...
                              : summary?.paymentMethod?.name == "openpay"
